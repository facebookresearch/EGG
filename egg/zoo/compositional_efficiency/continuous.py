...
def get_params(params):
    ...
    parser.add_argument('--receiver_cell', type=str,
                        default='lstm', choices=["lstm", "tree"])
...
def main(params):
    ...
    test_loader = DataLoader(
        train_data, batch_size=opts.batch_size, shuffle=False)
    ...
    receiver = Receiver(n_hidden=opts.receiver_hidden,
                        n_dim=2, inner_layers=opts.receiver_layers)
