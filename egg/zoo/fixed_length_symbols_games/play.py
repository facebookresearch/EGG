...
def main(params):
    ...
    if opts.mode.lower() == "gs":
        ...
        sender = core.FixedLengthSenderGS(
            sender,
        ...
        receiver = core.FixedLengthReceiverGS(
            receiver,
            vocab_size=opts.vocab_size,
        ...
        print("Using Fixed Length API!")
        game = core.FixedLengthSenderReceiverGS(sender, receiver, loss)
