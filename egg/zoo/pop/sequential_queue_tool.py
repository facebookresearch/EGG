...
def write_sequential_jobs(
    json_path: str,
    logfile_path: str = "/mnt/efs/fs1/logs/",
    prefix: str = "incep_hp_search",
    command_path: str = "~",
    gpu: Optional[int] = None,
) -> None:
    """
    Write sequential jobs to a command file for execution.

    :param json_path: Path to the JSON file containing job parameters.
    :param logfile_path: Path to the log file directory.
    :param prefix: Prefix for the log file names.
    :param command_path: Path to the command file.
    :param gpu: GPU ID to use (optional).
    """
