...
def get_data_opts(parser):
    ...
    group.add_argument(
        "--dataset_name",
        choices=["cifar100", "imagenet", "gaussian_noise", "inaturalist", "imagenet_alive"],
        default="imagenet",
...
def get_vision_module_opts(parser):
    ...
    group.add_argument(
        ...
        type=str,
        default="",
        choices=["resnet50", "resnet101", "resnet152", "vgg11", "inception", "vit", "swin","dino","visformer","vit_deit","beit"],
